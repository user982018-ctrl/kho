 ...
 public function crawlerPancakePage($page, $group)
  { 
    ...
    if ( $pIdPan != '' && $token != '' && $namePage != '' && $linkPage != '' && $chatId != '') {
      ...
      $endpoint = "$endpoint?type=PHONE,DATE:$before+-+$today&access_token=$token";
    // $endpoint = "$endpoint?type=PHONE&access_token=$token";
      $response = Http::withHeaders(['access_token' => $token])->get($endpoint);


// /****/
// $data = $json_data = file_get_contents('https://pancake.vn/api/v1/pages/655010087689861/conversations?type=PHONE,DATE:1751706240+-+1751879040&access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7Ql7cp6q4-cG6RYt_hnUKAjBn62Ef-SxuE6cWHe2Tno?type=PHONE&access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7Ql7cp6q4-cG6RYt_hnUKAjBn62Ef-SxuE6cWHe2Tno');
